...
⚠️ **每張卡片的推薦角度必須不同**，而且**每張卡片只講一個重點，限 2 行以內**。

> **主題純度最高：[基金A](URL)**
> AI 持股合計 45% — 想要最「純」的選這檔
>
> **近一年績效最強：[基金B](URL)**
> 1 年報酬 33%，同類前 5% — 績效導向首選
>
> **波動較小適合穩健型：[基金C](URL)**
> 風險等級 RR3，標準差低於同類科技平均 — AI 但不要太暴衝
>
> **有配息的 AI 基金：[基金D](URL)**
> 季配息率 4.2% — 想參與 AI 又想領息的折衷選擇

⚠️ **卡片精簡規則**：
- 每張卡片**只放跟該角度相關的 1-2 個數據**，不要每張都列完整持股明細 + 報酬 + 風險等級
- 「主題純度」→ 只講合計比例，不用列 6 家公司名稱
- 「績效最強」→ 只講報酬率，不需要再列持股
- 「穩健型」→ 只講風險等級或標準差，不需要持股
- 每張卡片最多 2 行。超過就太長了
