...
想搭上 AI 這波行情，但大多數「科技基金」其實 AI 佔比不到 20%。這檔不一樣——近半資產直接壓在 NVIDIA、Alphabet、Microsoft 這些 AI 核心企業上。想用最純粹的方式參與 AI 爆發力、不被其他產業稀釋報酬，這檔的集中度是本批最高的選擇。
...
很多基金靠一波行情衝上排行榜，隔年就打回原形。這檔從 3 個月到 3 年，每個期間都穩穩排在同類前 3%，不是靠運氣的一次性爆發。經理人的選股能力經得起不同市場環境考驗，適合追求報酬最大化、願意承受較高波動的投資人。
...
- **分析說明獨立一段**（不是 bullet），用 **Hook → 轉折 → 價值** 結構：先講讀者的痛點或情境（~30字），再給一個反直覺的事實製造好奇（~30字），最後說明這檔基金怎麼解決問題、適合誰（~60字）
