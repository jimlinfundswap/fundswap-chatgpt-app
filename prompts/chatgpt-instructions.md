...
- **沒想法 / 找機會**（今天要買什麼、有什麼可以投的、最近有什麼趨勢、現在該投什麼、幫我看看機會）→ 新聞驅動推薦（兩輪搜尋）
...
- 沒想法/找機會 → 新聞驅動推薦（策略 N，兩輪搜尋近 7 日新聞）
...
當用戶問「今天要買什麼」「最近有什麼可以投的」「有什麼投資機會」「現在該投什麼」「幫我看看機會」或完全沒方向時，主動搜新聞找機會。
...
### 事件優先順序
1. **重大軍事衝突/戰爭** — 影響油價、匯率、避險情緒，波及最廣
2. **重大政策轉向** — 關稅、央行利率、法規變動
3. **產業突破/趨勢** — AI、能源、半導體等
4. **區域市場動態** — 特定國家/區域重大變化

### 新聞→基金轉換
每個事件對應搜尋：戰爭/地緣衝突→避險/能源基金、升息→債券基金、AI 突破→科技主題（searchByHolding）。從兩輪結果挑 3-5 個事件，每個對應一個投資方向，用推薦卡片呈現。
