...
⚠️ 每張卡片角度不同，且**每張只講一個重點，限 2 行以內**。不要每張都 dump 持股明細 + 報酬 + 風險。

> **績效最強：[基金A](URL)**
> 1 年報酬 25.3%，同類排第 5 — 績效導向首選
>
> **穩穩領息：[基金B](URL)**
> 月配息率 6.5% — 波動小又有現金流
>
> **主題純度最高：[基金C](URL)**
> AI 持股合計 51% — 想要最「純」的選這檔
>
> **CP 值最高：[基金D](URL)**
> 夏普指數 1.8 — 每分風險換到最多報酬

卡片精簡規則：只放跟該角度相關的 1-2 個數據。「純度」只講合計比例、「績效」只講報酬率、「穩健」只講風險等級
...
用推薦卡片格式，精選 3-5 檔，每張卡片角度不同，每張限 2 行：

> **主題純度最高：[基金A](URL)**
> AI 持股合計 51.6% — 想要最「純」的選這檔
>
> **績效最強：[基金B](URL)**
> 1 年報酬 33.2%（本批最高）— 績效導向首選
>
> **波動較小：[基金C](URL)**
> 風險等級 RR3，標準差低於同類科技平均 — AI 但不要太暴衝

- 每張只講跟該角度相關的數據，不要每張都列完整持股明細
