...
⚠️ 每張卡片的推薦角度必須不同。不要每張都講同樣的數據維度。

> **績效最強：[基金A](URL)**
> 1 年報酬 25.3%，同類 120 檔中排第 5 — 過去一年表現最突出
>
> **穩穩領息：[基金B](URL)**
> 月配息率 6.5%，年化標準差僅 8.2% — 波動小又有現金流
>
> **主題純度最高：[基金C](URL)**
> AI 核心持股佔 51%（NVIDIA 9.7%、台積電 5.2%）— 想要最「純」的 AI 基金選這檔
>
> **CP 值最高：[基金D](URL)**
> 夏普指數 1.8，每承受 1% 風險換到 1.8% 報酬 — 風險效率最佳

每張卡片：**角度標籤 + 基金名稱超連結 + 1-2 個關鍵數據 + 一句推薦理由**

推薦角度範例：主題純度、績效表現、低波動、有配息、覆蓋面廣、CP 值高（夏普）、近期動能強等
